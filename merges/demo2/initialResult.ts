...
// -----------------------------------------------------------------------------------------------------------------------
<<<<<<< .\input1.ts
let _enableSnapshotPotentialLeakWarning = 1;
=======
let _enableSnapshotPotentialLeakWarning = 2;
>>>>>>> .\input2.ts
...
<<<<<<< .\input1.ts
		return snapshot((listener, thisArgs, disposables?) => event(i => listener.call(thisArgs, map(i)), null, disposables), disposable);
=======
		return snapshot((listener, thisArgs = 1, disposables?) => event(i => listener.call(thisArgs, map(i)), null, disposables), disposable);
>>>>>>> .\input2.ts
	}
